export default {
  ...
  actions: {
    leftMenuMode ({commit}, val){
      commit('leftMenuMode', val)
    },
    rightBarMode ({commit}, val){
      commit('rightBarMode', val)
    },
    propertyTabMode ({commit}, val){
      commit('propertyTabMode', val)
      commit('leftMenuMode', val)
    },
    colorPicker ({commit}, val){
      commit('colorPicker', val)
    },
  },
	mutations: {
    leftMenuMode (state, val){
      state.leftMenuMode = val
    },
    rightBarMode (state, val){
			state.rightBarMode = val
		},
    propertyTabMode (state, val){
      state.propertyTabMode = val
    },
    colorPicker (state, val){
